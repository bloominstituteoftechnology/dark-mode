...
- [ ] Create a new directory called `hooks`, and a new file in it called `useLocalStorage.js`.
...
- [ ] Inside the `hooks` directory, add a new file called `useDarkMode.js`.
...
- [ ] Look into the [Recharts](http://recharts.org/en-US/) library and build a new chart. Or change the appearence of the charts we built out here. Maybe when you toggle to dark mode, the line on the chart could change colors! There's a lot you can do with this library. Explore and have fun!
